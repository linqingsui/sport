 ...
 */
typedef void (^BlockHTTPRequestSuccess)(NSURLSessionTask *operation, id responseObject);
typedef void (^BlockHTTPRequestFailure)(NSURLSessionTask *operation, NSError *error);
...
typedef void (^BlockHTTPRequestCache)(NSURLSessionTask *operation, id responseObject, eURLCachePolicy cachePolicy);
 ...
 */
@interface FFMNetworking : AFHTTPSessionManager
 ...
 *  @return 已发送的request 可以为nil
 */
- (NSURLSessionTask *)POST:(NSURL *)urlPath
                           param:(NSDictionary *)params
                        JSONModelClass:(Class)responseModelClass
 ...
 *  @return 已发送的request 可以为nil
 */
- (NSURLSessionTask *)sendRequestForURL:(NSURL *)fullURL
