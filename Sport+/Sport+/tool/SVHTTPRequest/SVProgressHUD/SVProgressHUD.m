...
+(void)showWithView:(UIView *)view duration:(NSTimeInterval)duration WithMaskType:(SVProgressHUDMaskType)maskType{
    [SVProgressHUD show];
    [[SVProgressHUD sharedView]dismissWithView:view afterDelay:duration];
...
+ (void)dismiss {
    [[[SVProgressHUD sharedView] viewWithTag:8080]removeFromSuperview];
...
- (void)dismissWithView:(UIView *)view afterDelay:(NSTimeInterval)seconds {
